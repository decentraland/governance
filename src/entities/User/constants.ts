...
export const GATSBY_DISCORD_PROFILE_VERIFICATION_URL =
  process.env.GATSBY_DISCORD_PROFILE_VERIFICATION_URL || clientEnv('GATSBY_DISCORD_PROFILE_VERIFICATION_URL')
