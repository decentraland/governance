...
export const allowManaSuccess = (chainId?: ChainId, hash?: string) => action(ALLOW_MANA_SUCCESS, chainId && hash ? buildTransactionPayload(chainId, hash) : {})
...
export const allowLandSuccess = (chainId: ChainId, hash: string) => action(ALLOW_LAND_SUCCESS, buildTransactionPayload(chainId, hash))
...
export const allowEstateSuccess = (chainId: ChainId, hash: string) => action(ALLOW_ESTATE_SUCCESS, buildTransactionPayload(chainId, hash))
...
export const revokeLandSuccess = (chainId: ChainId, hash: string) => action(REVOKE_LAND_SUCCESS, buildTransactionPayload(chainId, hash))
...
export const revokeEstateSuccess = (chainId: ChainId, hash: string) => action(REVOKE_ESTATE_SUCCESS, buildTransactionPayload(chainId, hash))
...
export const wrapManaSuccess = (chainId: ChainId, hash: string, amount: number) => action(WRAP_MANA_SUCCESS, buildTransactionPayload(chainId, hash, { amount }))
...
export const unwrapManaSuccess = (chainId: ChainId, hash: string, amount: number) => action(UNWRAP_MANA_SUCCESS, buildTransactionPayload(chainId, hash, { amount }))
