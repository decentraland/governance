...
export async function up(pgm: MigrationBuilder): Promise<void> {
  const sql = `
    ...
    INSERT INTO proposal_survey_topics (id, topic_id, proposal_type, proposal_sub_types) VALUES (gen_random_uuid(), 'beneficiary', 'grant', '["Community", "Content Creator", "Platform Contributor", "Gaming"]');
    INSERT INTO proposal_survey_topics (id, topic_id, proposal_type, proposal_sub_types) VALUES (gen_random_uuid(), 'specification', 'grant', '["Community", "Content Creator", "Platform Contributor", "Gaming"]');
    ...
    INSERT INTO proposal_survey_topics (id, topic_id, proposal_type, proposal_sub_types) VALUES (gen_random_uuid(), 'value_proposition', 'grant', '["Community", "Content Creator", "Platform Contributor", "Gaming"]');
  `
