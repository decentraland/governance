...
export async function up(pgm: MigrationBuilder): Promise<void> {
  const sql = `
    ...
    INSERT INTO proposal_survey_topics (id, topic_id, proposal_type, proposal_sub_types) VALUES (gen_random_uuid(), 'personnel', 'grant', '["Community", "Content Creator", "Platform Contributor", "Gaming", "Accelerator", "Core Unit", "Documentation", "In-World Content", "Platform", "Social Media Content", "Sponsorship"]');
    ...
    INSERT INTO proposal_survey_topics (id, topic_id, proposal_type, proposal_sub_types) VALUES (gen_random_uuid(), 'potential_impact', 'grant', '["Community", "Content Creator", "Platform Contributor", "Gaming", "Accelerator", "Core Unit", "Documentation", "In-World Content", "Platform", "Social Media Content", "Sponsorship"]');
  `
