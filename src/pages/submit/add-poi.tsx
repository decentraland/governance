...
export default function SubmitPOI() {
    ...
    if (state.validated) {
      Promise.resolve()
        .then(async () => {
          ...
          return Governance.get().createAddProposalPOI({
            x,
            y,
  ...
  if (!account) {
    return (
      <Container>
        <Head
          title={l("page.submit_poi.add.title") || ""}
  ...
  return (
    <ContentLayout small>
      <Head
        ...
        image="https://decentraland.org/images/decentraland.png"
      />
      <Helmet title={l("page.submit_poi.add.title") || ""} />
      <ContentSection>
        <Header size="huge">{l("page.submit_poi.add.title")}</Header>
      </ContentSection>
      <ContentSection>
        <Paragraph small>{l("page.submit_poi.description")}</Paragraph>
      </ContentSection>
      <ContentSection className="CoordinatesField">
        <Label>{l("page.submit_poi.add.coordinates_label")}</Label>
      ...
      <ContentSection>
        ...
        <Paragraph tiny secondary className="details">
          {l("page.submit_poi.add.description_detail")}
        </Paragraph>
        <MarkdownTextarea
          minHeight={175}
          value={state.value.description}
          placeholder={l("page.submit_poi.add.description_placeholder")}
