...
import { getProposalSecondaryType } from "../../entities/Proposal/utils"
...
export default function ProposalItem({
  ...
  const choices = useMemo(
    (): string[] => proposal?.snapshot_proposal?.choices || [],
    [proposal]
  )
  const winner = useMemo(() => calculateResultWinner(choices, votes || {}), [
    choices,
    votes,
  ])
      ...
      <Card.Content>
        <div className="ProposalItem__Title">
          ...
          {account && (
            ...
            >
              <img
                src={subscribed ? subscribedIcon : subscribeIcon}
                width="20"
                height="20"
              />
            </Button>
