...
export default function ProposalUpdate({
  ...
  const UpdateIcon = completion_date ? Document : Cancel
  ...
  if (expanded && completion_date) {
    return (
      ...
      >
        <div className="ProposalUpdate__Heading">
          <div className="ProposalUpdate__Left">
            <UpdateIcon
              size="15"
              className={TokenList.join([
                "ProposalUpdate__Icon",
                `ProposalUpdate__Icon--${status}`,
              ])}
            />
            <span
              className={TokenList.join([
        ...
        <div
          className={TokenList.join([
            "ProposalUpdate__KeepReading",
            `ProposalUpdate__KeepReading--${status}`,
          ])}
        >
          Keep reading
    ...
    >
      <div className="ProposalUpdate__Left">
        ...
        <div className="ProposalUpdate__Description">
          <span className="ProposalUpdate__Month">
            {l("page.proposal_detail.grant.update_index", { index })}:
          </span>
