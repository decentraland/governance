...
export const TEST_CHOICES: string[] = [
  'Yes, we need a VR client for Decentraland',
  'Refund the DAO for the costs associated with this Grant',
  'This option has 100chars 00000000000000 0000000000000 0000000000000000000000 000000 0000000000000 00',
]
