...
export default class VotingPower extends React.PureComponent<Props> {
  render() {
    ...
    let className = 'VotingPower ' + (this.props.size || 'medium')
    ...
    return <div className={className}>
      <div>{t('general.number', { value })}</div>
